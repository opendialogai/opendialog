            ...
            <tr>
                ...
                <td class="actions">
                    <ul class="list-unstyled">
                        <li>
                            <a data-scaffold-action="webchat_settings-view" href="{{ url('/cms/webchat_settings/' . $child->id) }}">
                                <i class="fa fa-eye"> View</i>
                            </a>
                        </li>
                        <li>
                            <a data-scaffold-action="webchat_settings-edit" href="{{ url('/cms/webchat_settings/' . $child->id . '/edit') }}">
                        ...
                        <li>
                            ...
                            <a
                                ...
                                href="{{ url('/cms/webchat_settings/' . $child->id . '/delete') }}">
