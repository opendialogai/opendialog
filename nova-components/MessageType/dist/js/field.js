...
Nova.booting(function (Vue, router) {
    Vue.component('index-message-type', __webpack_require__(3));
    Vue.component('detail-message-type', __webpack_require__(6));
    Vue.component('form-message-type', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        if (this.field.value == 'user') {
            this.$parent.$el.classList.add('message', 'user');
        } else if (this.field.value == 'chatbot') {
            this.$parent.$el.classList.add('message', 'chatbot');
        }
    }
});
