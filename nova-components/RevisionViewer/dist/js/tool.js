...
Nova.booting(function (Vue, router, store) {
    Vue.component('RevisionViewer', __webpack_require__(2));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        window.axios.get('/nova/conversation-log/' + this.resourceId).then(function (response) {
          ...
          _vm._l(_vm.rows, function(row, i) {
            return [
              _c("tr", [
                ...
                _vm._v(" "),
                _c("td", [_vm._v(_vm._s(row.updates))]),
                _vm._v(" "),
                _c("td", [
                  row.class
                    ? _c(
              ...
              _vm._v(" "),
              _c("tr", { class: row.class }, [
                _c("td", {
                  attrs: { colspan: "4" },
                  domProps: { innerHTML: _vm._s(row.format) }
                })
              ])
            ]
          })
...
var staticRenderFns = [
  function() {
    ...
    return _c("thead", [
      ...
      _vm._v(" "),
      _c("th", { staticClass: "text-left" }, [_vm._v("User")]),
      _vm._v(" "),
      _c("th", { staticClass: "text-left" }, [_vm._v("Updates")]),
      _vm._v(" "),
