...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-message-builder', __webpack_require__(3));
    Vue.component('detail-message-builder', __webpack_require__(6));
    Vue.component('form-message-builder', __webpack_require__(14));
});
...
var update = __webpack_require__(10)("7f4ef86d", content, false, {});
...
// module
exports.push([module.i, "\n.message .text-message[data-v-0224618e],\n.message .button-message[data-v-0224618e],\n.message .image-message[data-v-0224618e] {\n  border-radius: 6px;\n  padding: 7px 10px;\n  background: #eaeaea;\n  max-width: 300px;\n}\n", ""]);
  ...
  return _c(
    ...
    [
      _c(
        "template",
        { slot: "value" },
        _vm._l(_vm.field.value, function(message) {
          return _c(
            "div",
              ...
              message.type == "text-message"
                ? [
                    _c("div", {
                      ...
                      domProps: { innerHTML: _vm._s(message.data) }
                    })
                  ]
                : _vm._e(),
              _vm._v(" "),
              message.type == "button-message"
                ? [
                    _c(
                      "div",
                      ...
                      [
                        _c("div", {
                          domProps: { innerHTML: _vm._s(message.data.text) }
                        }),
                        _vm._v(" "),
                        _vm._l(message.data.buttons, function(button) {
                          return _c("div", { staticClass: "buttons" }, [
                            _c(
                              "button",
                              {
                                staticClass:
                                  "btn btn-default btn-primary mt-1 mr-2"
                              },
                ...
                ? [
                    _c(
                      ...
                      [
                        message.data.link
                          ? [
                              _c("a", { attrs: { href: message.data.link } }, [
                                _c("img", { attrs: { src: message.data.src } })
                              ])
                            ]
                          : [_c("img", { attrs: { src: message.data.src } })]
                      ],
